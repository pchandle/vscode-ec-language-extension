...
The extension relies upon indexing specification data from the Valley using a Studio server. Please make sure you have configured the extension to your local Studio server. The indexing of specifications may take several minutes to complete.
