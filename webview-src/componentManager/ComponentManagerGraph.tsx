...
export type ComponentGraphState = {
  ...
  protocol?: { kind: "managed" | "legacy"; source: Source; selfMappingUnavailable?: Partial<Record<"host" | "join", string>> };
  jobs: GraphJob[];
